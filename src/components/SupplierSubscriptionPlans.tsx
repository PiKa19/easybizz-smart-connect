...
interface SupplierSubscriptionPlansProps {
  onPlanSelect: (plan: { duration: string; price: number; planType: string }) => void;
  onBack: () => void;
}

const SupplierSubscriptionPlans = ({ onPlanSelect, onBack }: SupplierSubscriptionPlansProps) => {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: ["Full access to all features", "Priority customer support", "Advanced analytics", "Save 16%"]
    },
    {
      id: "1year",
      duration: "1 Year",
      ...
      features: ["Full access to all features", "Priority customer support", "Advanced analytics", "Save 12%", "Free training sessions"]
    }
  ];
